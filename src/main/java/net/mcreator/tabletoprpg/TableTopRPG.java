 ...
 *
 *    Keep the ElementsTableTopRPG object in this class and all calls to this object
...
public class TableTopRPG {
	...
	@Mod.Instance(MODID)
	public static TableTopRPG instance;
	public ElementsTableTopRPG elements = new ElementsTableTopRPG();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsTableTopRPG.GuiHandler());
